//Global def
let cell, firstPlayer, secondPlayer, guj, gear, gun, celurit,hand;
let turn = 'first'
let weaponTiles = []
let notAllowedTiles = []
let availableCell
...
const weapons = [{name: "hand"},{name: "guj"},{name: "gear"},{name: "gun"},{name: "celurit"}];
...
//function add weapon image and attack value in the player board
...
$('#start_button').click(function(){
    ...
    guj = new weapon("guj", weaponTiles[0],"guj", 15);
    gear = new weapon("gear", weaponTiles[1],"gear", 25);
    gun  = new weapon("gun", weaponTiles[2],"gun", 35);
